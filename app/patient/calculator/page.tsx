...
import { Home, Calendar, Calculator, BookOpen, Phone, Activity, ShoppingCart, Package } from "lucide-react"
        ...
        <div className="space-y-8">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mt-2">
              Easily calculate accurate dosages by selecting your parameters with our Peptide Reconstitution Calculator
              below.
            </p>
          </div>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Choose the desired dose in milligrams (mg). This is the amount of peptide you plan to inject each
                    time.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Select the amount of peptide in your vial. Common amounts include 1mg, 5mg, 10mg, or 15mg.
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    The calculator will show a visual meter indicating the exact amount to draw up in your syringe.
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
                <li>
                  Always use bacteriostatic water <strong>with Benzyl Alcohol 0.09%</strong> for reconstitution
                </li>
                ...
                <li>If you&apos;re unsure about dosing, contact your provider immediately</li>
              </ul>
            </CardContent>
          </Card>
        </div>
